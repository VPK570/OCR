...
def get_args_parser():
    ...
    parser.add_argument('--pth_path', type=str, default=None, help='starting checkpoint for fine-tuning')
    ...
    IAM.add_argument('--test-data-list', type=str, default='./data/iam/test.ln',
                     help='test data list')
    IAM.add_argument('--pth_path', type=str, default=None, help='starting checkpoint for fine-tuning')
